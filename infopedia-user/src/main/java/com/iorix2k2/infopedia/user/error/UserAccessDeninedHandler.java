...
@Component
public class UserAccessDeninedHandler implements AccessDeniedHandler
{
	@Override
			...
			AccessDeniedException accessDeniedException) throws IOException, ServletException
	{
		...
		var message = "You are not authorized to access this feature or the request is invalid!";
