...
public interface UserRepository extends JpaRepository<User, Long>
{
	...
	List<User> findReducedByUsernameContainingIgnoreCase(String username);
	...
	List<Object[]> findReducedTopAmountOrderByRandom(Long amount);
	
	@Query("SELECT new User(u.id, u.username, age, gender, country) " +
			"FROM User u WHERE u.id=:id")
	Optional<User> findReducedById(Long id);
